      ...
      <div className="max-w-xl w-full bg-white/80 backdrop-blur-xl p-6 sm:p-8 rounded-[2rem] shadow-[0_20px_50px_rgba(8,_112,_184,_0.07)] border border-white relative z-10 animate-fade-in-up">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500 text-sm font-medium">
            أدِر حسابات أبنائك، تابع مستواهم، واحجز لهم أفضل المعلمين.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2">
                ...
                <div className="relative group">
                  <div className="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-purple-600 transition-colors">
                  ...
                  <input
                    ...
                    className="w-full pr-10 pl-4 py-2.5 bg-gray-50/50 hover:bg-gray-50 border-2 border-transparent focus:ring-4 focus:ring-purple-100 focus:border-purple-500 rounded-xl outline-none transition-all duration-300 font-medium placeholder:text-gray-400 text-sm"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative group">
                  <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-purple-600 transition-colors">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-gray-50/50 hover:bg-gray-50 border-2 border-transparent focus:ring-4 focus:ring-purple-100 focus:border-purple-500 rounded-xl outline-none transition-all duration-300 text-left font-medium placeholder:text-gray-400 text-sm"
                    dir="ltr"
                  />
                </div>
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full pl-10 pr-10 py-2.5 bg-gray-50/50 hover:bg-gray-50 border-2 border-transparent focus:ring-4 focus:ring-purple-100 focus:border-purple-500 rounded-xl outline-none transition-all duration-300 text-left tracking-widest font-medium placeholder:tracking-normal placeholder:text-gray-400 text-sm"
                    dir="ltr"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-purple-600 transition-colors p-1"
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={loading}
                className="group relative w-full flex justify-center py-3.5 px-4 text-sm font-bold rounded-xl text-white bg-gradient-to-r from-purple-600 via-purple-500 to-violet-600 hover:shadow-[0_10px_20px_rgba(147,51,234,0.3)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-70 disabled:cursor-not-allowed transition-all duration-300 transform hover:-translate-y-0.5"
              >
                {loading ? (
