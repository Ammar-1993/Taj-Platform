...
import { Headphones, Home, Plus, HelpCircle } from "lucide-react";
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <span className={`text-2xl drop-shadow-sm transition-transform duration-500 ${isOpen ? "scale-110 rotate-6" : "opacity-80 group-hover:scale-110"}`}>
                            {faq.icon}
                          </span>
