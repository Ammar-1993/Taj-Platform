...
describe('DashboardHeader', () => {
  ...
  it('renders welcome message for student', () => {
    ...
    expect(screen.getByText('بوابة الطالب لإدارة الحجوزات والمحفظة')).toBeInTheDocument()
  })
  ...
  it('renders welcome message for teacher', () => {
    ...
    expect(screen.getByText('بوابة المعلم لإدارة الحصص والأرباح')).toBeInTheDocument()
  })
  ...
  it('renders welcome message for parent', () => {
    ...
    expect(screen.getByText('لوحة المراقبة الشاملة لحجوزات ونفقات الأبناء')).toBeInTheDocument()
  })
