          ...
          <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div className="w-full md:w-auto text-center md:text-right">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
                <span className="text-3xl md:text-4xl drop-shadow-lg animate-subtle-pulse">
                  👑
                </span>
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 lg:flex lg:items-center lg:justify-end w-full lg:w-auto gap-2 sm:gap-3 mt-4 lg:mt-0">
              {authLoading ? (
                ...
                <Button
                  asChild
                  variant="default"
                  className="flex-1 md:flex-none py-3.5 bg-white text-brand-700 hover:bg-gray-50"
                >
                ...
                <>
                  <Button
                    asChild
                    variant="outline"
                    className="flex-1 md:flex-none border-white/20 bg-white/10 hover:bg-white/20 text-white backdrop-blur-md"
                  >
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="flex-1 md:flex-none border-white/20 bg-white/20 hover:bg-white/30 text-white backdrop-blur-md"
                  >
                  ...
                  <Button
                    asChild
                    variant="gradient"
                    className="flex-1 md:flex-none h-12 px-8 shadow-xl"
                  >
                    ...
                    <CardFooter className="flex flex-col sm:flex-row justify-between items-center pt-5 border-t border-gray-50 mt-auto gap-4 sm:gap-0">
                      ...
                      {(teacher.active_slots_count || 0) > 0 ? (
                        <Button
                          asChild
                          variant="default"
                          className="w-full sm:w-auto px-6 rounded-taj-lg"
                        >
                        ...
                        <Button
                          disabled
                          className="w-full sm:w-auto px-6 rounded-taj-lg bg-slate-100 text-slate-500 font-medium border-none cursor-not-allowed"
                        >
                          <CalendarX size={14} />
                          غير متاح حالياً
                        </Button>
